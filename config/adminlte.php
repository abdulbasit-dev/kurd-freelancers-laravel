    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Accept Posts',
                    'url'  => 'dashboard/posts/accept',
                    'icon' => 'far fa-calendar-check mr-2',
                ],
                [
                    'text'    => 'Pending Posts',
                    'url'  => 'dashboard/posts/pending',
                    'icon'    => 'fas fa-chalkboard-teacher mr-2'
                ],
                [
                    'text' => 'Reject Posts',
                    'url'  => 'dashboard/posts/reject',
                    'icon' => 'far fa-calendar-times mr-2'
                ],
            ],
        ],
        [
